...
@section('titulo', 'Editar usuario - Controlsys S.L')
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="{{asset('imagenes-perfiles/'. $usuario->avatar)}}"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <i class="fas fa-envelope" aria-hidden="true"></i> &nbsp;{{$usuario->email}}
                  </li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="informacion">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input type="text" class="form-control-file" value="{{$usuario->id}}"  name="idOculto" hidden>
                    </div>
